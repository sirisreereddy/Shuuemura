...
public class UQSU82 extends BaseTest
{
public UQSU82() 
{
	super("UQSU82");
...
public UQSU82(String testName, String browser) {
...
public void test() throws Exception {
	...
	if(channel.equalsIgnoreCase("Desktop")){
		...
		objData.setTestData();
		test.log(LogStatus.PASS,"TEST CASE NAME:REGISTERED USER CARD CHECKOUT DISCOVER");
		Reporter.log("TEST CASE NAME:REGISTERED USER CARD CHECKOUT DISCOVER");
		...
		cp.enterCreditCardDetails(objData.credname,objData.cardtype4,objData.crednumber4,objData.expmonth,objData.expyear,objData.cvv1);
		cp.clickSubmitOrder();
