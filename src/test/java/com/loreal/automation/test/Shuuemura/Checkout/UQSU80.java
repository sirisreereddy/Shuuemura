...
public class UQSU80 extends BaseTest
{
public UQSU80() 
{
	super("UQSU80");
...
public UQSU80(String testName, String browser) {
...
public void before() {
	...
	test = TestReportGenerator(report, this.getClass().getSimpleName(),"REGISTERED USER CARD CHECKOUT MASTER");
}
...
public void test() throws Exception {
	...
	if(channel.equalsIgnoreCase("Desktop")){
		...
		objData.setTestData();
		test.log(LogStatus.PASS,"TEST CASE NAME:REGISTERED USER CARD CHECKOUT MASTER");
		Reporter.log("TEST CASE NAME:REGISTERED USER CARD CHECKOUT MASTER");
		...
		cp.enterCreditCardDetails(objData.credname,objData.cardtype2,objData.crednumber2,objData.expmonth,objData.expyear,objData.cvv1);
		cp.clickSubmitOrder();
