...
public class UQSU76 extends BaseTest
{
public UQSU76() 
{
	super("UQSU76");
...
public UQSU76(String testName, String browser) {
...
public void test() throws Exception {
	...
	if(channel.equalsIgnoreCase("Desktop")){
		...
		objData.setTestData();
		test.log(LogStatus.PASS,"TEST CASE NAME:GUEST USER CARD CHECKOUT MASTER");
		Reporter.log("TEST CASE NAME:GUEST USER CARD CHECKOUT MASTER");
