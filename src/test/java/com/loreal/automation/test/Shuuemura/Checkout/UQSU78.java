...
public class UQSU78 extends BaseTest
{
public UQSU78() 
{
	super("UQSU78");
...
public UQSU78(String testName, String browser) {
...
public void test() throws Exception {
	...
	if(channel.equalsIgnoreCase("Desktop")){
		...
		objData.setTestData();
		test.log(LogStatus.PASS,"TEST CASE NAME:GUEST USER CARD CHECKOUT DISCOVER ");
		Reporter.log("TEST CASE NAME:GUEST USER CARD CHECKOUT DISCOVER");
