...
public class UQSU77 extends BaseTest
{
public UQSU77() 
{
	super("UQSU77");
...
public UQSU77(String testName, String browser) {
...
public void test() throws Exception {
	...
	if(channel.equalsIgnoreCase("Desktop")){
		...
		objData.setTestData();
		test.log(LogStatus.PASS,"TEST CASE NAME:GUEST USER CARD CHECKOUT AMEX");
		Reporter.log("TEST CASE NAME:GUEST USER CARD CHECKOUT AMEX");
