...
public class UQSU79 extends BaseTest
{
public UQSU79() 
{
	super("UQSU79");
...
public UQSU79(String testName, String browser) {
...
public void test() throws Exception {
	...
	if(channel.equalsIgnoreCase("Desktop")){
		...
		objData.setTestData();
		test.log(LogStatus.PASS,"TEST CASE NAME:REGISTERED USER CARD CHECKOUT VISA");
		Reporter.log("TEST CASE NAME:REGISTERED USER CARD CHECKOUT VISA");
