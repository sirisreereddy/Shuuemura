...
public class TestNGCustomReportListener implements IReporter {
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
        ...
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "Shuuemura"+Filename+"_"+System.currentTimeMillis()+".html"))));
    ...
    public void generateSuiteSummaryReport(List<ISuite> suites) {
        ...
        tableColumnStart("Start Date<br/>(MM-DD-YYYY)");
        tableColumnStart("End Date<br/>(MM-DD-YYYY)");
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r : tests.values()) {
                ...
                SimpleDateFormat summaryDate=new SimpleDateFormat("MM-dd-yyyy");
                summaryCell(summaryDate.format(overview.getStartDate()),true);
                out.println("</td>");

                summaryCell(summaryDate.format(overview.getEndDate()),true);
                out.println("</td>");
